...
async def main():
    ...
    try:
        # First session
        print("--- Session 1 ---")
        session1 = await client.create_session({"model": "claude-haiku-4.5", "on_permission_request": PermissionHandler.approve_all})
        ...
        print("--- Session 2 ---")
        session2 = await client.create_session({"model": "claude-haiku-4.5", "on_permission_request": PermissionHandler.approve_all})
