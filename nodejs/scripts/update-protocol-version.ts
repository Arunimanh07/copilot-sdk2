...
const minVersion = (versionFile as Record<string, unknown>).minVersion as number | undefined ?? version;

console.log(`Generating SDK protocol version constants for version ${version} (min: ${minVersion})...`);
 ...
 */
export const MIN_SDK_PROTOCOL_VERSION = ${minVersion};
...
// Servers reporting a version in [Min, Max] are considered compatible.
const MinSdkProtocolVersion = ${minVersion}
...
MIN_SDK_PROTOCOL_VERSION = ${minVersion}
"""The minimum SDK protocol version supported."""
...
internal static class SdkProtocolVersion
{
    ...
    /// Servers reporting a version in [Min, Max] are considered compatible.
    /// </summary>
    private const int MinVersion = ${minVersion};
